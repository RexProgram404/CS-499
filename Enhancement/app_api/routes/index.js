...
const authConstrollor = require('../controllers/authentication');
...
router.route('/register').post(authConstrollor.register);
router.route('/login').post(authConstrollor.login);
